        ...
        <div class="content">
            ...
            <section id="rooms-table">
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{route('delete_product',$product->id)}}" id="dd" class="d-inline-block control-button delete mb-2 m-lg-0">
                            <i class="fas fa-trash-alt"></i> 
                            Delete
                        </a>
                    </td>
                    <td>    
                        <a href="{{route('edit_product_page',$product->id)}}" id="dd" class="d-inline-block control-button edit ">
                ...
                <a href="{{route('add_product_page')}}" class="r-btn">
